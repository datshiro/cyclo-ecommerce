...
var BrandWhere = struct {
	...
	ID:        whereHelperint{field: "\"cyclo\".\"brands\".\"id\""},
	Name:      whereHelperstring{field: "\"cyclo\".\"brands\".\"name\""},
	CreatedAt: whereHelpertime_Time{field: "\"cyclo\".\"brands\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"cyclo\".\"brands\".\"updated_at\""},
	DeletedAt: whereHelpernull_Time{field: "\"cyclo\".\"brands\".\"deleted_at\""},
}
...
var (
	brandAllColumns            = []string{"id", "name", "created_at", "updated_at", "deleted_at"}
	brandColumnsWithoutDefault = []string{"name"}
	brandColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at"}
...
func (o *Brand) Products(mods ...qm.QueryMod) productQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"cyclo\".\"products\".\"brand_id\"=?", o.ID),
	)
...
func (brandL) LoadProducts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBrand interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`cyclo.products`),
		qm.WhereIn(`cyclo.products.brand_id in ?`, args...),
		qmhelper.WhereIsNull(`cyclo.products.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func Brands(mods ...qm.QueryMod) brandQuery {
	mods = append(mods, qm.From("\"cyclo\".\"brands\""), qmhelper.WhereIsNull("\"cyclo\".\"brands\".\"deleted_at\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"cyclo\".\"brands\".*"})
	}
...
func FindBrand(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Brand, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"cyclo\".\"brands\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
...
func (o *Brand) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"cyclo\".\"brands\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"cyclo\".\"brands\" %sDEFAULT VALUES%s"
		}
...
func (o *Brand) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"cyclo\".\"brands\" SET %s WHERE %s",
...
func (o BrandSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"cyclo\".\"brands\" SET %s WHERE %s",
...
func (o *Brand) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"cyclo\".\"brands\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Brand) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"cyclo\".\"brands\" WHERE \"id\"=$1"
	} else {
		currTime := time.Now().In(boil.GetLocation())
		o.DeletedAt = null.TimeFrom(currTime)
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"cyclo\".\"brands\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
...
func (o BrandSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"cyclo\".\"brands\" WHERE " +
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"cyclo\".\"brands\" SET %s WHERE "+
...
func (o *BrandSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"cyclo\".\"brands\".* FROM \"cyclo\".\"brands\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, brandPrimaryKeyColumns, len(*o)) +
...
func BrandExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"cyclo\".\"brands\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
