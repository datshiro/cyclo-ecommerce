...
var ProductWhere = struct {
	...
	ID:        whereHelperint{field: "\"cyclo\".\"products\".\"id\""},
	Name:      whereHelperstring{field: "\"cyclo\".\"products\".\"name\""},
	Price:     whereHelperfloat64{field: "\"cyclo\".\"products\".\"price\""},
	BrandID:   whereHelperint{field: "\"cyclo\".\"products\".\"brand_id\""},
	CreatedAt: whereHelpertime_Time{field: "\"cyclo\".\"products\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"cyclo\".\"products\".\"updated_at\""},
	DeletedAt: whereHelpernull_Time{field: "\"cyclo\".\"products\".\"deleted_at\""},
}
...
var (
	productAllColumns            = []string{"id", "name", "price", "brand_id", "created_at", "updated_at", "deleted_at"}
	productColumnsWithoutDefault = []string{"name", "price", "brand_id"}
...
func (productL) LoadBrand(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProduct interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`cyclo.brands`),
		qm.WhereIn(`cyclo.brands.id in ?`, args...),
		qmhelper.WhereIsNull(`cyclo.brands.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Product) SetBrand(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Brand) error {
	...
	updateQuery := fmt.Sprintf(
		"UPDATE \"cyclo\".\"products\" SET %s WHERE %s",
...
func Products(mods ...qm.QueryMod) productQuery {
	mods = append(mods, qm.From("\"cyclo\".\"products\""), qmhelper.WhereIsNull("\"cyclo\".\"products\".\"deleted_at\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"cyclo\".\"products\".*"})
	}
...
func FindProduct(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Product, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"cyclo\".\"products\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
...
func (o *Product) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"cyclo\".\"products\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"cyclo\".\"products\" %sDEFAULT VALUES%s"
		}
...
func (o *Product) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"cyclo\".\"products\" SET %s WHERE %s",
...
func (o ProductSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"cyclo\".\"products\" SET %s WHERE %s",
...
func (o *Product) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"cyclo\".\"products\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Product) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"cyclo\".\"products\" WHERE \"id\"=$1"
	} else {
		currTime := time.Now().In(boil.GetLocation())
		o.DeletedAt = null.TimeFrom(currTime)
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"cyclo\".\"products\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
...
func (o ProductSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"cyclo\".\"products\" WHERE " +
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"cyclo\".\"products\" SET %s WHERE "+
...
func (o *ProductSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"cyclo\".\"products\".* FROM \"cyclo\".\"products\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, productPrimaryKeyColumns, len(*o)) +
...
func ProductExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"cyclo\".\"products\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
